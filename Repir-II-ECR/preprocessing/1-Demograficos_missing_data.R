...
data$Edad_inicio_ERC <- round(get_age(data$Fecha_nacimiento, data$Fecha_inicio_ERC, dec = T), 2)

data$Tiempo_evolucion_hastadiagnostico <- round(get_age(data$Fecha_inicio_ERC, data$Fecha_diagnostico_ERC, dec = T), 2)
