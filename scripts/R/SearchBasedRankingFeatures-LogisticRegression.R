...
output <- "results/4horas-withoutRNU1/Classification/"

#load the dataset and ranking of features
dataset <-  read.csv("4horas-withoutRNU1-preproc.csv")

rankingFeature <- read.csv("4horas-withoutRNu1-preproc-sortedfeatures.csv", sep = "\t")
