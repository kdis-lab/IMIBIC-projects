...
output <- "results/0-4horas-withoutRNU1/"

fileName <- "0-4horas-withoutRNu1-preproc"
...
png(paste(output, fileName,"-VarImp.png", sep = ""), width = 8, height = 6, units="in", res=200)

viplot(newData$Importance, xlab = as.vector(newData$Var),
