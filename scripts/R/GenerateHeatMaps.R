...
setwd("D:/OneDrive - Universidad de C?rdoba/workspace/IMIBIC/")
...
#Load the dataset
datasetName <- "cancer/v2/ControlvsTumoral-withoutOutliers-preproc"
data <- read.csv(paste("datasets/",datasetName,".csv",sep=""))

#Load csv with cluster configurations

pathOutput <- paste("reports/",datasetName,"/HierarchicalClusterer/notAllSignificantFactors",sep = "")
